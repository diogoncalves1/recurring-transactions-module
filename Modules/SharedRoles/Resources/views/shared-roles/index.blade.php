...
@section('title', 'Papéis de Partilha')

@section('breadcrumb')
    <li class="breadcrumb-item active">Papéis de partilha</li>
@endsection
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('admin.shared-roles.create') }}" class="btn btn-default">Adicionar Papel de
                                Partilha</a>
                        </div>
                        <div class="card-body">
