...
@section('title', 'Gerir Permissões do Papel de Partilha')
...
@section('breadcrumb')
    <li class="breadcrumb-item"><a class="text-dark" href="{{ route('admin.shared-roles.index') }}">Papéis de partilha</a></li>
