...
class ResetPasswordMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $emailText = str_replace(['[$user_name]', '[$reset_password_link]'],
            [$this->user->name, config('app.frontend_url') . '/change-password?token=' . $user->createToken('web-token')->plainTextToken], $this->emailLayout->email);
