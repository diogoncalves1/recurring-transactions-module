...
@section('title', 'Palavras-Chave de Notificação')
...
@section('breadcrumb')
    <li class="breadcrumb-item active">Palavras-Chave de Notificação</li>
@endsection
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('admin.notificationKeywords.create') }}" class="btn btn-default">Adicionar
                                Palavra-Chave de Notificação</a>
                        </div>
                        <div class="card-body">
