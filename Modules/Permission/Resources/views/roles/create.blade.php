...
@section('title', (isset($role) ? 'Editar' : 'Adicionar') . ' Papel')

@section('breadcrumb')
    <li class="breadcrumb-item active"><a class="text-dark" href="{{ route('admin.roles.index') }}">Papéis</a>
    </li>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" value='{{ $role->code ?? '' }}'
