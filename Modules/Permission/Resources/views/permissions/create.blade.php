...
@section('title', (isset($permission) ? 'Editar ' : 'Adicionar ') . ' Permissão')
...
@section('breadcrumb')
    <li class="breadcrumb-item active"><a class="text-dark" href="{{ route('admin.permissions.index') }}">Permissões</a>
    </li>
                            ...
                            @can('authorization', 'superAdmin')
                                <div class="icheck-danger d-inline">
                                    <input type="checkbox" name="visible" id="visible" value="1"
                                        {{ isset($permission) && $permission->visible == 0 ? '' : 'checked' }}>
